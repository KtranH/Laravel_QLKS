                        ...
                        <div class="card info-card customers-card" style="border-radius:20px">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        <h6>1244</h6>
                                        <span class="text-danger small pt-1 fw-bold">Đánh giá</span><span
                                        ...
                                        <div class="Ha card my-specific-card {{$r->ISDELETE==0 ? 'disabled':''}}">
                                            ...
                                            <div class="card-info">
                                                ...
                                                <p class="card-text"><i class="fa-solid fa-couch"
                                                        style="color:gray;margin-right:10px;"></i><span
                                            ...
                                            <div class="card-footer" style="border-radius:20px;background-color:gray">
                                                ...
                                                <p class="card-text"><i class="fa-solid fa-couch"
                                                        ...
                                                        style="font-weight:bold;">Nội thất:</span>{{ $r->NOITHAT }}
                                                </p>
                                                <p class="card-text"><i class="fa-solid fa-hotel"
                                                        style="color:#74C0FC;margin-right:10px;"></i><span
                                                        style="font-weight:bold;">Diện
                                            ...
                                            <div class="card-footer" style="border-radius:20px">
                                                ...
                                                @endif
                                                <a class="card-button"
                                                    href="{{ route("overviewProduct",["idroom" => $r->MALP]) }}">
