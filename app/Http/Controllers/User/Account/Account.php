    ...
    public function saveEdit(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                ...
                DB::update(
                    'UPDATE khachhang SET HOTEN = ?, DIACHI = ?, SDT = ?, CCCD = ?, EMAIL = ?, NGAYSINH = ?, GIOITINH = ?, AVATAR = ?, USERNAME = ? WHERE EMAIL = ? OR USERNAME = ?',
                ...
                $takeName = $data['user'];
                DB::update(
                    'UPDATE khachhang SET HOTEN = ?, DIACHI = ?, SDT = ?, CCCD = ?, NGAYSINH = ?, GIOITINH = ? WHERE EMAIL = ? OR USERNAME = ?',
                    [$fullName, $address, $phone, $cccd, $birthday, $gender, $takeName, $takeName]
                );
            } else {
                DB::update(
                    'UPDATE khachhang SET HOTEN = ?, DIACHI = ?, SDT = ?, CCCD = ?, EMAIL = ?, NGAYSINH = ?, GIOITINH = ?, USERNAME = ? WHERE EMAIL = ? OR USERNAME = ?',
