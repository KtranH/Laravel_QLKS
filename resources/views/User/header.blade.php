...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
        <form class="search-form d-flex align-items-center">
            <input type="text" name="search" id="search" placeholder="Tìm kiếm phòng" class="form-control"
                onfocus="this.value=''">
    ...
    <nav class="header-nav ms-auto">
      ...
      ?>
            ...
            @endphp
            <li style="width:200px;margin-right:30px">
                <a class="button_cart_khoi" href="{{ route("cartUser") }}"
                    style="max-width:10px;height:5px;margin-right: 20px"
                    title="<?php echo "Bạn đang có " . $countGioHang . " sản phẩm trong giỏ" ?>">
            ...
            <li class="nav-item dropdown pe-3">
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    ...
                    @else
                    <img src="{{ Storage::url('public/img/' . $checkUser[0]->AVATAR ) }}" alt="Profile"
      ...
      ?>
            ...
            <li> <a class="Button_Khoi" style="background-color:#74C0FC;color:white" href="{{ route("FormSignUp") }}">
                    Đăng ký </a></li>
            <?php
      }
      ?>
