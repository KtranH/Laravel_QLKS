                                        ...
                                        ">
                                            ...
                                            <table class="table table-borderless">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <th scope="row"><img src="{{ $selectImg[0] }}"
                                                                style="max-width:50px; height:50px; border-radius:10px; box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; object-fit: cover;"
                                                                alt=""></th>
                            ...
                            <div class="col-12">
                                <div class="card" style="border-radius:20px">
                                    <div class="card-body">
                                        ...
                                        font-optical-sizing: auto;
                                        font-weight: 600;
                                        font-style: normal;">Phương thức thanh toán<span>/Lựa chọn thanh toán</span>
                                        </h5>
                                        <div class="row bg-white" style="padding:20px;border-radius:20px;width:100%;display:flex;justify-content: space-between;
                                        ">
                                            ...
                                            <div class="plan">
                                                <div class="inner">
                                                    ...
                                                    <p class="info">Vui lòng chuyển vào tài khoản sau, chúng tôi sẽ xác
                                                    ...
                                                    <ul class="features">
                                                        ...
                                                        <li>
                                                            ...
                                                            @endphp
                                                            <span>Nội dung:<strong>
                                                                    {{ $checkUser[0]->MAKH. $currentDate. $currentTime}}
                                                                </strong></span>
                                                        </li>
                                                        <li>
                                                            <span class="icon">
                                                    ...
                                                    <div class="action">
                                                        ...
                                                        @if ($count > 1)
                                                        <a id="pay" class="button"
                                                            href="{{ route("confirmpaycart",["dater" => $DateR, "datep" => $DateP,"sumPay"=>$pay]) }}">
                                                            Xác nhận
                                                        </a>
                                                        @else
                                                        <a id="pay" class="button"
                                                            href="{{ route("confirmpay",["dater" => $DateR, "datep" => $DateP, "idroom" => $selectPay[0]->MALP,"sumPay"=>$pay]) }}">
                                                            Xác nhận
                                                        </a>
                                                        @endif
                                                    </div>
                                                    ...
                                                    a.addEventListener('click', function(event) {
                                                        const inputValueDateR = document.getElementById('dater')
                                                            .value;
                                                        const inputValueDateP = document.getElementById('datep')
                                                            .value;
                                                        const inputTakeDateR = document.getElementById('taker')
                                                            .value;
                                                        const inputTakeDateP = document.getElementById('takep')
                                                            .value;
                                    ...
                                    <div class="card-body">
                                        ...
                                        ">
                                            ...
                                            <p style="color:red"><i class="fa-solid fa-ban" style="color: #74C0FC;"></i>
                                                ...
                                                hủy phòng trước <span style="font-weight:bold">1 ngày</span> khi tới
                                                ngày nhận phòng và bị trừ 20 điểm tín nhiệm. <br><br> Nếu bạn hủy sau 24
                                                tiếng thì bạn<span style="font-weight:bold">không thể hủy phòng</span>.
                                                Điểm tín nhiệm dưới 20 bạn không thể đặt phòng trước cũng như bị khóa
                                                tài khoản.</p>
                                ...
                                <div class="card" style="border-radius:20px">
                                    <div class="card-body">
                                        ...
                                        ">
                                            ...
                                            <div class="form-label" style="width:100%; color: red">
                                                {{ Session::get('failDate') }}</div>
                                            @php
                                            Session::forget('failDate');
                                            @endphp
                                            @endif
                                            <form id="dateForm" method="post"
                                                action="{{ route("paymentUserCart",["sumPay" => $sum]) }}">
                                                @csrf
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text">Ngày nhận phòng</span>
                                                    <input type="date" class="form-control" id="dater"
                                                        placeholder="Username" name="DateR" aria-label="Username"
                                                        aria-describedby="basic-addon1" value="{{ $DateR }}">
                                                </div>

                                                <div class="input-group mb-3">
                                                    <span class="input-group-text">Ngày trả phòng</span>
                                                    <input type="date" class="form-control" id="datep"
                                                        placeholder="Username" name="DateP" aria-label="Username"
                                                        aria-describedby="basic-addon1" value="{{ $DateP }}">
                                                </div>


                                                <button type="submit" class="btn btn-info"
                                                    style="border-radius:20px;margin-right:20px;color:white;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;background-color:#74C0FC;width:100%"><i
                                                        class="fi fi-rr-file-edit"></i> Đồng ý</button>
                                            ...
                                            @endif
                                            <form id="dateForm" method="POST"
                                                action="{{ route("payUser",["sumPay" => $sum]) }}">
                                                @csrf
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text">Ngày nhận phòng</span>
                                                    <input type="date" class="form-control" id="dater"
                                                ...
                                                <input type="hidden" id="takeIdRoom" name="takeIdRoom"
                                                    value="{{ $takeIdRoom }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        ">
                                            ...
                                            <p style="display:flex; justify-content: space-between;margin-bottom:30px;">
                                                <span style="font-weight:bold">Tạm tính:</span> Bạn sẽ thuê trong
                                                {{$duration. " đêm = " . $sum }} VNĐ</p>
                                            <p style="display:flex; justify-content: space-between;"><span
                                                    style="font-weight:bold">Tổng tiền: </span><span
                                                    style="margin-top:-10px; color: red;font-size:25px">{{ $sum }}
                                                    VNĐ</span></p>
                                        </div>
                                    </div>
